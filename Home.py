...
# --- CHAMA A BARRA LATERAL (que agora contém o CSS e a navegação) ---
# É importante que a barra lateral seja criada antes de qualquer outro elemento da página
...
# --- TÍTULO CENTRALIZADO COM LOGO E SUBTEXTO ---
# CORREÇÃO APLICADA AQUI: URL do logo inserida diretamente
logo_url = "https://raw.githubusercontent.com/gabrielxrm-lab/sjfc-streamlit-app/main/logo_sao_jorge.png"
st.markdown(f"""
